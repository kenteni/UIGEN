...
test("MessageList renders multiple messages in correct order", () => {
  ...
  // Get all message containers in order - they are divs with gap-2 class inside items-end/justify containers
  const messageContainers = container.querySelectorAll(".rounded-2xl.px-4");
...
test("MessageList shows loading for assistant message with empty parts", () => {
  ...
  // Check for typing indicator (animated dots) - should have 3 animated spans
